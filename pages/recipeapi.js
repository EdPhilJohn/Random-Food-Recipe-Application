//Spoonacular API, create an API key and replace it in getStaticProps
...
export const getStaticProps = async () => {
    const response = await fetch("https://api.spoonacular.com/recipes/random?number=1&apiKey=YOURKEY")
